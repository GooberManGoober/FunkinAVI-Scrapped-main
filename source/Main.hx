...
class Main extends Sprite
{
	...
	public static var initialState:Class<FlxState> = /*EVILantileakState; *uncomment for playtest builds*/ states.menus.TitleState; // The FlxState the game starts with.
