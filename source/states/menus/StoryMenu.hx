...
class StoryMenu extends MusicBeatState
{
	...
	//	scoreText.screenCenter(X);
		...
		var ui_tex = Paths.getSparrowAtlas('Funkin_avi/storymenu/campaign_menu_UI_assets');
		...
		var tracksSprite:FlxSprite = new FlxSprite(FlxG.width * 0.07, bgSprite.y + 425).loadGraphic(Paths.image('Funkin_avi/storymenu/Menu_Tracks'));
		...
		transitionThing = new FlxSprite(-1700, 0).loadGraphic(Paths.image('Funkin_avi/storymenu/storyMenuTransition'));
		add(transitionThing);
	...
	function changeWeek(change:Int = 0):Void
	{
		...
		if(assetName == null || assetName.length < 1) {
			...
			bgSprite.loadGraphic(Paths.image('Funkin_avi/storymenu/menubackgrounds/menu_' + assetName));
		}
